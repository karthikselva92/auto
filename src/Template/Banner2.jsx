            ...
            <div class="row  mb--n30">
                <div class="col-lg-6 col-md-6 mb-30">
                    <div class="banner__items position__relative">
                        <a class="banner__thumbnail display-block" href="shop.html">
                            <img class="banner__thumbnail--img" src="assets/img/banner/banner16.webp" alt="banner-img"/>
                ...
                <div class="col-lg-6 col-md-6 mb-30">
                    <div class="banner__items position__relative">
                        <a class="banner__thumbnail display-block" href="shop.html">
                            <img class="banner__thumbnail--img" src="assets/img/banner/banner17.webp" alt="banner-img"/>
                            <div class="banner__content--style4">
