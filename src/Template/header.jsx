                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html">
                            <img class="main__logo--img" src="assets/img/logo/logo.png" alt="logo-img"/></a></h1>
                    </div>
                        ...
                        <li class="header__account--items d-none d-lg-block">
                            ...
                            <li class="header__account--items header__minicart--items">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=" -user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <span class="minicart__btn--text">Hello, Login <br/> <span class="minicart__btn--text__price">My Account</span></span>
                                </a>
                            </li>
        ...
        <div class="container">
                <div class="header__bottom--inner position__relative d-flex align-items-center">
                    <div class="categories__menu ">
                        <div class="categories__menu--header bg__secondary text-white d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#categoriesAccordion" onClick={(e)=>{setCategory(!category)}}>
                        ...
                        <div class={(!category)?"dropdown__categories--menu border-radius-5 active collapse":"dropdown__categories--menu border-radius-5 active" } id="categoriesAccordion">
                    ...
                    <ul class="offcanvas__menu_ul">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        ...
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">My Account 2</a></li>                                    </ul>
                                </li>
                                <li class="offcanvas__sub_menu_li">
                                    <a href="#" class="offcanvas__sub_menu_item">Column Three</a>
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">About Us</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Contact Us</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="#">Portfolio</a></li>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Contact Us</a></li>
